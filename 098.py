...
def main():
    ...
    if opt == '3':
        return opt
    if opt == '4':
        os.system(f'xdg-open https://www.facebook.com/profile.php?id=100087079881481&mibextid=ZbWKwL')
        return opt
    if opt == '5':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100087079881481&mibextid=ZbWKwL');time.sleep(1)
        return opt
    if opt == '6':
        os.system(f'xdg-open https://www.facebook.com/profile.php?id=100087079881481&mibextid=ZbWKwL')
        os.system('Exit')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100087079881481&mibextid=ZbWKwL', {
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
update = requests.get("https://github.com/MR-Arabul-Islam/job.txt/blob/main/hot.txt").text
...
myweb2 = requests.get("https://github.com/MR-Arabul-Islam/job.txt/blob/main/hot.txt").text
logo = ("""
\033[0;95m     ██ ██ ███████  █████  ███    ██ 
\033[0;95m     ██ ██ ██      ██   ██ ████   ██ 
\033[0;95m     ██ ██ ███████ ███████ ██ ██  ██ 
...
\033[1;32m[-] WHATSAPP  :\033[1;32m +918293430036
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get("https://github.com/MR-Arabul-Islam/job.txt/blob/main/hot.txt").text
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+918293430036?text={bumper}")
                        qsbuy()
